        ...
        try{
            ...
            while (sc.hasNextLine()){
               ...
               if (line.contains("<entity")){
                   ...
                   String serialNumber = hm.get("value");
                   ...
                   T s = (T)Class.forName(objectClass).getDeclaredConstructor(String.class,String.class).newInstance(serialNumber,name);
                   s.setId((ID)id);
                   entities.add(s);
                   }
               }
