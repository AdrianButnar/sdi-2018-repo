...
public class ProblemController {
    ...
    public ProblemsDto getStudents() {
        log.trace("get Problems");

        List<Problem> problems = problemService.getAllProblems();

        log.trace("get Problems: problems={}", problems);
    ...
    public ProblemDto createProblem(
        ...
        log.trace("create Problem: problemDtoMap={}", problemDto);
        ...
        log.trace("create Problem: result={}", result);
        return result;
    }
    ...
    public ResponseEntity deleteProblem(@PathVariable final Long problemId) {
        log.trace("delete Problem: problemId={}", problemId);

        problemService.deleteProblem(problemId);

        log.trace("delete Problem - method end");
