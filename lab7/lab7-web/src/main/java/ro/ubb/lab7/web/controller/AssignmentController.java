...
public class AssignmentController {
    ...
    public AssignmentsDto getAssignments() {
        log.trace("getAssignment");

        List<Assignment> assignments = assignmentService.getAllAssignments();

        log.trace("getAssignment: assignments={}", assignments);
    ...
    public AssignmentDto createAssignment(
        ...
        log.trace("create Assignment: assignmentDtoMap={}", assignmentDto);
        ...
        log.trace("create Assignment: result={}", result);
        return result;
    }
    ...
    public ResponseEntity deleteAssignment(@PathVariable final Long assignmentId) {
        log.trace("delete Assignment: assignmentId={}", assignmentId);

        assignmentService.deleteAssignment(assignmentId);

        log.trace("delete Assignment - method end");
